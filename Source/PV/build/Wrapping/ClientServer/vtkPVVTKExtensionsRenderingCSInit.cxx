...
extern void vtkAllToNRedistributeCompositePolyData_Init(vtkClientServerInterpreter* csi);
extern void vtkAllToNRedistributePolyData_Init(vtkClientServerInterpreter* csi);
extern void vtkBalancedRedistributePolyData_Init(vtkClientServerInterpreter* csi);
extern void vtkRedistributePolyData_Init(vtkClientServerInterpreter* csi);
extern void vtkWeightedRedistributePolyData_Init(vtkClientServerInterpreter* csi);
extern void vtkMPICompositeManager_Init(vtkClientServerInterpreter* csi);
extern void vtkIceTCompositePass_Init(vtkClientServerInterpreter* csi);
extern void vtkIceTContext_Init(vtkClientServerInterpreter* csi);
  ...
  vtkClientServerInterpreter *csi)
{
  ...
  vtkMPICompositeManager_Init(csi);
  vtkIceTCompositePass_Init(csi);
  vtkIceTContext_Init(csi);
