...
#include "../../../ParaView/Qt/Core/pqOutputWindowModel.h"
...
static const char qt_meta_stringdata_pqOutputWindowModel[] = {
    "pqOutputWindowModel\0"
};
...
const QMetaObjectExtraData pqOutputWindowModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqOutputWindowModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_pqOutputWindowModel,
      qt_meta_data_pqOutputWindowModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqOutputWindowModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqOutputWindowModel))
