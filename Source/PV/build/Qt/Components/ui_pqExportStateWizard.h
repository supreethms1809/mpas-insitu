...
public:
    ...
    QStackedWidget *cinemaContainer;
    QCheckBox *liveViz;
    ...
    void setupUi(QWizard *ExportStateWizard)
    {
        ...
        ExportStateWizard->resize(583, 724);
        ...
        gridLayout_4->addWidget(nextView, 8, 1, 1, 1);
        ...
        viewsContainer->setMinimumSize(QSize(300, 220));
        viewsContainer->setFrameShape(QFrame::Box);
        viewsContainer->setFrameShadow(QFrame::Sunken);

        gridLayout_4->addWidget(viewsContainer, 5, 0, 1, 2);

        cinemaContainer = new QStackedWidget(wizardPage_2);
        cinemaContainer->setObjectName(QString::fromUtf8("cinemaContainer"));
        cinemaContainer->setEnabled(false);
        sizePolicy.setHeightForWidth(cinemaContainer->sizePolicy().hasHeightForWidth());
        cinemaContainer->setSizePolicy(sizePolicy);
        cinemaContainer->setMinimumSize(QSize(300, 150));
        cinemaContainer->setFrameShape(QFrame::Box);
        cinemaContainer->setFrameShadow(QFrame::Sunken);

        gridLayout_4->addWidget(cinemaContainer, 11, 0, 1, 2);
        ...
        nextTrack = new QPushButton(wizardPage_2);
        nextTrack->setObjectName(QString::fromUtf8("nextTrack"));
        nextTrack->setEnabled(false);

        gridLayout_4->addWidget(nextTrack, 12, 1, 1, 1);
        ...
        gridLayout_4->addWidget(rescaleDataRange, 4, 0, 1, 1);
        ...
        gridLayout_4->addWidget(outputRendering, 3, 0, 1, 2);

        outputCinema = new QCheckBox(wizardPage_2);
        outputCinema->setObjectName(QString::fromUtf8("outputCinema"));

        gridLayout_4->addWidget(outputCinema, 2, 0, 1, 1);
        ...
        gridLayout_4->addWidget(previousView, 8, 0, 1, 1);

        previousTrack = new QPushButton(wizardPage_2);
        previousTrack->setObjectName(QString::fromUtf8("previousTrack"));
        previousTrack->setEnabled(false);

        gridLayout_4->addWidget(previousTrack, 12, 0, 1, 1);
        ...
        QObject::connect(outputCinema, SIGNAL(toggled(bool)), previousTrack, SLOT(setVisible(bool)));
        QObject::connect(outputCinema, SIGNAL(toggled(bool)), nextTrack, SLOT(setVisible(bool)));
        QObject::connect(outputCinema, SIGNAL(toggled(bool)), cinemaContainer, SLOT(setVisible(bool)));

        cinemaContainer->setCurrentIndex(-1);
    ...
    void retranslateUi(QWizard *ExportStateWizard)
    {
        ...
        nextTrack->setText(QApplication::translate("ExportStateWizard", "Next Track", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_TOOLTIP
        outputCinema->setToolTip(QApplication::translate("ExportStateWizard", "Export views as cinema databases for deferred visualization", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        outputCinema->setText(QApplication::translate("ExportStateWizard", "Output to Cinema", 0, QApplication::UnicodeUTF8));
        previousView->setText(QApplication::translate("ExportStateWizard", "Previous View", 0, QApplication::UnicodeUTF8));
        previousTrack->setText(QApplication::translate("ExportStateWizard", "Previous Track", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
