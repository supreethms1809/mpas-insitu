...
extern "C" void vtkRenderingParallelLICCS_Initialize(vtkClientServerInterpreter*);
...
extern "C" void vtkFiltersImagingCS_Initialize(vtkClientServerInterpreter*);
extern "C" void vtkFiltersParallelImagingCS_Initialize(vtkClientServerInterpreter*);
...
void PARAVIEW_CSSTREAMS_INITIALIZE(vtkClientServerInterpreter* interp)
{
  ...
  vtkParallelMPICS_Initialize(interp);
  ...
  vtkIOMPIImageCS_Initialize(interp);
  ...
  vtkFiltersParallelMPICS_Initialize(interp);
  ...
  vtkRenderingParallelLICCS_Initialize(interp);
  ...
  vtkFiltersParallelFlowPathsCS_Initialize(interp);
  vtkFiltersImagingCS_Initialize(interp);
  vtkFiltersParallelImagingCS_Initialize(interp);
  ...
  vtkIOParallelNetCDFCS_Initialize(interp);
  ...
  vtkParallelMPI4PyCS_Initialize(interp);
