...
const char* vtkFiltersImagingLibraries[] = { "vtkFiltersImaging-pv4.3", "vtkFiltersImaging-pv4.3", NULL };
const char* vtkFiltersImagingDepends[] = { "vtkFiltersStatistics", "vtkImagingGeneral", "vtkImagingSources", NULL };
...
const char* vtkRenderingParallelLICLibraries[] = { "vtkRenderingParallelLIC-pv4.3", "vtkRenderingParallelLIC-pv4.3", NULL };
const char* vtkRenderingParallelLICDepends[] = { "vtkIOLegacy", "vtkParallelMPI", "vtkRenderingLIC", "vtkRenderingOpenGL", NULL };
...
const char* vtkIOMPIImageLibraries[] = { "vtkIOMPIImage-pv4.3", "vtkIOMPIImage-pv4.3", NULL };
const char* vtkIOMPIImageDepends[] = { "vtkIOImage", "vtkIOImage", "vtkParallelMPI", "vtksys", NULL };
...
const char* vtkPVServerManagerApplicationDepends[] = { "vtkChartsCore", "vtkCommonExecutionModel", "vtkDomainsChemistry", "vtkFiltersAMR", "vtkFiltersCore", "vtkFiltersExtraction", "vtkFiltersFlowPaths", "vtkFiltersGeneral", "vtkFiltersGeneric", "vtkFiltersGeneric", "vtkFiltersGeometry", "vtkFiltersHybrid", "vtkFiltersHyperTree", "vtkFiltersModeling", "vtkFiltersParallel", "vtkFiltersParallel", "vtkFiltersParallelFlowPaths", "vtkFiltersParallelImaging", "vtkFiltersParallelMPI", "vtkFiltersParallelStatistics", "vtkFiltersProgrammable", "vtkFiltersPython", "vtkFiltersSources", "vtkFiltersStatistics", "vtkFiltersTexture", "vtkFiltersVerdict", "vtkIOAMR", "vtkIOEnSight", "vtkIOExodus", "vtkIOExport", "vtkIOGeometry", "vtkIOGeometry", "vtkIOImage", "vtkIOImage", "vtkIOImport", "vtkIOInfovis", "vtkIOLegacy", "vtkIOMPIImage", "vtkIOMovie", "vtkIONetCDF", "vtkIOPLY", "vtkIOParallel", "vtkIOParallel", "vtkIOParallelExodus", "vtkIOParallelLSDyna", "vtkIOParallelNetCDF", "vtkIOVPIC", "vtkIOXML", "vtkIOXML", "vtkIOXdmf2", "vtkImagingCore", "vtkImagingFourier", "vtkImagingHybrid", "vtkImagingMorphological", "vtkImagingSources", "vtkInteractionImage", "vtkInteractionStyle", "vtkInteractionWidgets", "vtkPVAnimation", "vtkPVServerManagerCore", "vtkPVServerManagerDefault", "vtkParallelMPI", "vtkParallelMPI4Py", "vtkRenderingAnnotation", "vtkRenderingContext2D", "vtkRenderingFreeType", "vtkRenderingFreeType", "vtkRenderingFreeTypeOpenGL", "vtkRenderingLIC", "vtkRenderingLOD", "vtkRenderingLabel", "vtkRenderingMatplotlib", "vtkRenderingOpenGL", "vtkRenderingParallel", "vtkRenderingParallelLIC", "vtkRenderingVolume", "vtkRenderingVolumeOpenGL", "vtkTestingRendering", "vtkUtilitiesProcessXML", "vtkViewsContext2D", "vtklibxml2", "vtksys", NULL };
...
const char* vtkPVClientServerCoreCoreDepends[] = { "vtkFiltersExtraction", "vtkFiltersParallel", "vtkFiltersProgrammable", "vtkPVCommon", "vtkPVCommon", "vtkPVVTKExtensionsCore", "vtkParallelMPI", "vtkPythonInterpreter", "vtkUtilitiesWrapClientServer", "vtkmpi4py", "vtksys", NULL };
...
const char* vtkFiltersParallelMPILibraries[] = { "vtkFiltersParallelMPI-pv4.3", "vtkFiltersParallelMPI-pv4.3", NULL };
const char* vtkFiltersParallelMPIDepends[] = { "vtkFiltersExtraction", "vtkFiltersGeneral", "vtkFiltersParallel", "vtkImagingCore", "vtkParallelCore", "vtkParallelMPI", NULL };
...
const char* vtkParallelMPILibraries[] = { "vtkParallelMPI-pv4.3", "vtkParallelMPI-pv4.3", NULL };
const char* vtkParallelMPIDepends[] = { "vtkParallelCore", NULL };
const char* vtkPVVTKExtensionsRenderingLibraries[] = { "vtkPVVTKExtensionsRendering-pv4.3", "vtkPVVTKExtensionsRendering-pv4.3", NULL };
const char* vtkPVVTKExtensionsRenderingDepends[] = { "vtkChartsCore", "vtkCommonColor", "vtkFiltersExtraction", "vtkFiltersGeneric", "vtkFiltersHyperTree", "vtkFiltersParallel", "vtkFiltersParallelMPI", "vtkGUISupportQt", "vtkIOExport", "vtkIOXML", "vtkInteractionStyle", "vtkInteractionWidgets", "vtkPVVTKExtensionsCore", "vtkRenderingAnnotation", "vtkRenderingFreeTypeOpenGL", "vtkRenderingLIC", "vtkRenderingMatplotlib", "vtkRenderingOpenGL", "vtkRenderingParallel", "vtkRenderingParallelLIC", "vtkUtilitiesEncodeString", "vtkicet", "vtkzlib", NULL };
...
const char* vtkIOParallelNetCDFLibraries[] = { "vtkIOParallelNetCDF-pv4.3", "vtkIOParallelNetCDF-pv4.3", NULL };
const char* vtkIOParallelNetCDFDepends[] = { "vtkCommonCore", "vtkParallelMPI", "vtknetcdf", NULL };
const char* vtkFiltersParallelImagingLibraries[] = { "vtkFiltersParallelImaging-pv4.3", "vtkFiltersParallelImaging-pv4.3", NULL };
const char* vtkFiltersParallelImagingDepends[] = { "vtkFiltersImaging", "vtkFiltersParallel", "vtkIOLegacy", "vtkImagingCore", "vtkParallelCore", NULL };
...
const char* vtkParallelMPI4PyLibraries[] = { "vtkParallelMPI4Py-pv4.3", "vtkParallelMPI4Py-pv4.3", NULL };
const char* vtkParallelMPI4PyDepends[] = { "vtkParallelMPI", "vtkPython", "vtkmpi4py", NULL };
...
const char* vtkFiltersParallelFlowPathsLibraries[] = { "vtkFiltersParallelFlowPaths-pv4.3", "vtkFiltersParallelFlowPaths-pv4.3", NULL };
const char* vtkFiltersParallelFlowPathsDepends[] = { "vtkFiltersAMR", "vtkFiltersFlowPaths", "vtkParallelCore", "vtkParallelMPI", NULL };
...
const char* vtkmpi4pyLibraries[] = { NULL };
const char* vtkmpi4pyDepends[] = { NULL };
