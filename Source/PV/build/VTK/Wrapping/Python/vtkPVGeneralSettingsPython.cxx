...
static PyMethodDef PyvtkPVGeneralSettings_Methods[] = {
  ...
  {(char*)"GetBlockColorsDistinctValues", PyvtkPVGeneralSettings_GetBlockColorsDistinctValues, METH_VARARGS,
   (char*)"V.GetBlockColorsDistinctValues() -> int\nC++: int GetBlockColorsDistinctValues()\n\nDetermines the number of distinct values in vtkBlockColors. This\narray is added to each block if the dataset is a composite\ndataset. The array has one value set to (blockIndex %\nBlockColorsDistinctValues)\n"},
  {(char*)"SetBlockColorsDistinctValues", PyvtkPVGeneralSettings_SetBlockColorsDistinctValues, METH_VARARGS,
   (char*)"V.SetBlockColorsDistinctValues(int)\nC++: void SetBlockColorsDistinctValues(int a)\n\nDetermines the number of distinct values in vtkBlockColors. This\narray is added to each block if the dataset is a composite\ndataset. The array has one value set to (blockIndex %\nBlockColorsDistinctValues)\n"},
