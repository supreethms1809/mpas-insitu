...
#ifndef DECLARED_PyvtkCornerAnnotation_TextPosition_Type
extern VTK_PYTHON_EXPORT PyTypeObject PyvtkCornerAnnotation_TextPosition_Type;
#define DECLARED_PyvtkCornerAnnotation_TextPosition_Type
#endif

PyTypeObject PyvtkCornerAnnotation_TextPosition_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,
  (char*)"TextPosition", // tp_name
...
static PyMethodDef PyvtkCornerAnnotation_Methods[] = {
  ...
  {(char*)"SetText", PyvtkCornerAnnotation_SetText, METH_VARARGS,
   (char*)"V.SetText(int, string)\nC++: void SetText(int i, const char *text)\n\nSet/Get the text to be displayed for each corner\\sa TextPosition\n"},
...
PyObject *PyVTKClass_vtkCornerAnnotationNew(const char *modulename)
{
  ...
  if (cls)
    ...
    PyvtkCornerAnnotation_TextPosition_Type.tp_new = NULL;

    o = (PyObject *)&PyvtkCornerAnnotation_TextPosition_Type;
    if (o && PyDict_SetItemString(d, (char *)"TextPosition", o) != 0)
      {
      Py_DECREF(o);
      }
