...
static PyMethodDef PyvtkPVBagChartRepresentation_Methods[] = {
  ...
  {(char*)"SetSelectionColor", PyvtkPVBagChartRepresentation_SetSelectionColor, METH_VARARGS,
   (char*)"V.SetSelectionColor(float, float, float)\nC++: void SetSelectionColor(double, double, double)\nV.SetSelectionColor((float, float, float))\nC++: void SetSelectionColor(double a[3])\n\n"},
  {(char*)"GetSelectionColor", PyvtkPVBagChartRepresentation_GetSelectionColor, METH_VARARGS,
   (char*)"V.GetSelectionColor() -> (float, float, float)\nC++: double *GetSelectionColor()\n\n"},
