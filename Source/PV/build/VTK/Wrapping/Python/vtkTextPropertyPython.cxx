...
static PyMethodDef PyvtkTextProperty_Methods[] = {
  ...
  {(char*)"SetBackgroundColor", PyvtkTextProperty_SetBackgroundColor, METH_VARARGS,
  ...
  {(char*)"GetBackgroundColor", PyvtkTextProperty_GetBackgroundColor, METH_VARARGS,
   (char*)"V.GetBackgroundColor() -> (float, float, float)\nC++: double *GetBackgroundColor()\n\n"},
  {(char*)"SetBackgroundOpacity", PyvtkTextProperty_SetBackgroundOpacity, METH_VARARGS,
   (char*)"V.SetBackgroundOpacity(float)\nC++: void SetBackgroundOpacity(double a)\n\nThe background opacity. 1.0 is totally opaque and 0.0 is\ncompletely transparent.\n"},
  {(char*)"GetBackgroundOpacity", PyvtkTextProperty_GetBackgroundOpacity, METH_VARARGS,
