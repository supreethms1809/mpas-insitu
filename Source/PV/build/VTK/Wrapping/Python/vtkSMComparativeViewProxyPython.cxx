...
static PyMethodDef PyvtkSMComparativeViewProxy_Methods[] = {
  ...
  {(char*)"GetInteractor", PyvtkSMComparativeViewProxy_GetInteractor, METH_VARARGS,
   (char*)"V.GetInteractor() -> vtkRenderWindowInteractor\nC++: virtual vtkRenderWindowInteractor *GetInteractor()\n\nReturns the render-window used by the root view, if any.\n"},
  {(char*)"SetupInteractor", PyvtkSMComparativeViewProxy_SetupInteractor, METH_VARARGS,
  ...
  {(char*)"MakeRenderWindowInteractor", PyvtkSMComparativeViewProxy_MakeRenderWindowInteractor, METH_VARARGS,
   (char*)"V.MakeRenderWindowInteractor(bool) -> bool\nC++: virtual bool MakeRenderWindowInteractor(bool quiet=false)\n\nOverridden to call MakeRenderWindowInteractor() on each of the\ninternal views.\n"},
  {NULL, NULL, 0, NULL}
};
