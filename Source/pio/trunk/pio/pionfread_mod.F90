...
!! @file 
!! $Revision: 1360 $
!! $LastChangedDate: 2014-12-02 11:27:03 -0500 (Tue, 02 Dec 2014) $
...
!<
  public :: read_nf
# 17 "/home/mpas/Desktop/Source/pio/trunk/pio/pionfread_mod.F90.in"
  interface read_nf
...
# 24 "/home/mpas/Desktop/Source/pio/trunk/pio/pionfread_mod.F90.in"
contains
...
!! @private
!<
# 30 "/home/mpas/Desktop/Source/pio/trunk/pio/pionfread_mod.F90.in"
    ...
    if (File%iosystem%IOproc) then
       ...
       case(pio_iotype_pnetcdf)
          ...
          print *,__PIO_FILE__,__LINE__, &
               ...
               start,' count: ', &
               count, ' iobuf size: ',size(iobuf), vardesc%varid
...
# 209 "/home/mpas/Desktop/Source/pio/trunk/pio/pionfread_mod.F90.in"
