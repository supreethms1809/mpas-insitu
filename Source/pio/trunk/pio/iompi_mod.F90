...
!! @file 
!! $Revision: 877 $
!! $LastChangedDate: 2013-12-06 14:36:54 -0500 (Fri, 06 Dec 2013) $
...
!! @private
!<
# 43 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
...
# 48 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
...
# 55 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
contains 

# 57 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
...
# 87 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
 end function close_mpiio

# 89 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
...
!        ' File%fh: ',File%fh
     ...
     ierr=0
#endif
# 130 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
 end function create_mpiio

# 132 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
 integer function open_mpiio(File,fname, CheckMPI) result(ierr)
     ...
     ierr=0
#endif
# 174 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
 end function open_mpiio


! TYPE int,real,double
# 178 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
 integer function write_mpiio_int (File,IOBUF,varDesc, iodesc) result(ierr)
    ...
    logical, parameter :: Check = .TRUE.
#ifdef TIMING
    call t_startf("pio_write_mpiio_int")
#endif
#ifdef USEMPIIO   
     datarep   = 'native'
     iotype    = File%iotype
...
!DBG     print *,'TEMPLATE_NAME(write_mpiio_): At the begining of subroutine: ',File%offset
     ...
     !-------------------------------------
     if(Debug) print *,__PIO_FILE__,__LINE__,' inside write_mpiio_int offset: ',File%offset
...
# 246 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
...
# 178 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
 integer function write_mpiio_real (File,IOBUF,varDesc, iodesc) result(ierr)
    ...
    logical, parameter :: Check = .TRUE.
#ifdef TIMING
    call t_startf("pio_write_mpiio_real")
#endif
#ifdef USEMPIIO   
     datarep   = 'native'
     iotype    = File%iotype
...
!DBG     print *,'TEMPLATE_NAME(write_mpiio_): At the begining of subroutine: ',File%offset
     ...
     ! Set file view for distributed array
     !-------------------------------------
     if(Debug) print *,__PIO_FILE__,__LINE__,' inside write_mpiio_real offset: ',File%offset
     call MPI_File_set_view(File%fh,File%offset, iodesc%Write%elemTYPE, iodesc%Write%fileTYPE, 'native',File%iosystem%info,ierr)
...
# 178 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
 integer function write_mpiio_double (File,IOBUF,varDesc, iodesc) result(ierr)
    ...
    logical, parameter :: Check = .TRUE.
#ifdef TIMING
    call t_startf("pio_write_mpiio_double")
#endif
#ifdef USEMPIIO   
     datarep   = 'native'
     iotype    = File%iotype
...
!DBG     print *,'TEMPLATE_NAME(write_mpiio_): At the begining of subroutine: ',File%offset
     ...
     ! Set file view for distributed array
     !-------------------------------------
     if(Debug) print *,__PIO_FILE__,__LINE__,' inside write_mpiio_double offset: ',File%offset
     call MPI_File_set_view(File%fh,File%offset, iodesc%Write%elemTYPE, iodesc%Write%fileTYPE, 'native',File%iosystem%info,ierr)
...
! TYPE int,real,double
# 249 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
...
!DBG     iodesc%Read%fileTYPE
     ...
     if(Check) call CheckMPIreturn('read_mpiio_int: after call to file_read_all: ',ierr)
     if(Debug) call MPI_get_count(fstatus,iodesc%Read%elemTYPE,cnt,ierr)
     if(Debug) print *,__PIO_FILE__,__LINE__,'IAM: ',File%iosystem%io_rank,'read_mpiio_int: cnt is: ',iodesc%Read%n_elemTYPE, cnt
     if(Debug) print *,__PIO_FILE__,__LINE__,'IAM: ',File%iosystem%io_rank,'read_mpio_int: reclen is: ',reclen
...
#endif
# 316 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
...
# 319 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
...
# 356 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
 end subroutine Write_FORTRAN_CntrlWord
!***********************************************************************
# 358 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
 subroutine Read_FORTRAN_CntrlWord(File,reclen)
     ...
     call piodie(__PIO_FILE__,__LINE__,'PIO was not built with -DUSEMPIIO')
#endif
# 391 "/home/mpas/Desktop/Source/pio/trunk/pio/iompi_mod.F90.in"
