...
!
! $Id: getput_vard.m4 1816 2014-10-11 04:19:56Z wkliao $
!
...
VARD1(put, inout, OneByteInt,    integer, int1)
VARD1(put, inout, TwoByteInt,    integer, int2)
VARD1(put, inout, FourByteInt,   integer, int)
VARD1(put, inout, FourByteReal,  real,    real)
VARD1(put, inout, EightByteReal, real,    double)
VARD1(put, inout, EightByteInt,  integer, int8)
...
VARD1(put, inout, OneByteInt,    integer, int1,   _all)
VARD1(put, inout, TwoByteInt,    integer, int2,   _all)
VARD1(put, inout, FourByteInt,   integer, int,    _all)
VARD1(put, inout, FourByteReal,  real,    real,   _all)
VARD1(put, inout, EightByteReal, real,    double, _all)
VARD1(put, inout, EightByteInt,  integer, int8,   _all)
...
VARD(put, 1D, TwoByteInt, integer, int2,  :,              inout)
VARD(put, 2D, TwoByteInt, integer, int2, `:,:',           inout)
VARD(put, 3D, TwoByteInt, integer, int2, `:,:,:',         inout)
VARD(put, 4D, TwoByteInt, integer, int2, `:,:,:,:',       inout)
VARD(put, 5D, TwoByteInt, integer, int2, `:,:,:,:,:',     inout)
VARD(put, 6D, TwoByteInt, integer, int2, `:,:,:,:,:,:',   inout)
VARD(put, 7D, TwoByteInt, integer, int2, `:,:,:,:,:,:,:', inout)

VARD(put, 1D, FourByteInt, integer, int,  :,              inout)
VARD(put, 2D, FourByteInt, integer, int, `:,:',           inout)
VARD(put, 3D, FourByteInt, integer, int, `:,:,:',         inout)
VARD(put, 4D, FourByteInt, integer, int, `:,:,:,:',       inout)
VARD(put, 5D, FourByteInt, integer, int, `:,:,:,:,:',     inout)
VARD(put, 6D, FourByteInt, integer, int, `:,:,:,:,:,:',   inout)
VARD(put, 7D, FourByteInt, integer, int, `:,:,:,:,:,:,:', inout)

VARD(put, 1D, FourByteReal, real,   real,  :,              inout)
VARD(put, 2D, FourByteReal, real,   real, `:,:',           inout)
VARD(put, 3D, FourByteReal, real,   real, `:,:,:',         inout)
VARD(put, 4D, FourByteReal, real,   real, `:,:,:,:',       inout)
VARD(put, 5D, FourByteReal, real,   real, `:,:,:,:,:',     inout)
VARD(put, 6D, FourByteReal, real,   real, `:,:,:,:,:,:',   inout)
VARD(put, 7D, FourByteReal, real,   real, `:,:,:,:,:,:,:', inout)

VARD(put, 1D, EightByteReal, real, double,  :,              inout)
VARD(put, 2D, EightByteReal, real, double, `:,:',           inout)
VARD(put, 3D, EightByteReal, real, double, `:,:,:',         inout)
VARD(put, 4D, EightByteReal, real, double, `:,:,:,:',       inout)
VARD(put, 5D, EightByteReal, real, double, `:,:,:,:,:',     inout)
VARD(put, 6D, EightByteReal, real, double, `:,:,:,:,:,:',   inout)
VARD(put, 7D, EightByteReal, real, double, `:,:,:,:,:,:,:', inout)

VARD(put, 1D, EightByteInt, integer, int8,  :,              inout)
VARD(put, 2D, EightByteInt, integer, int8, `:,:',           inout)
VARD(put, 3D, EightByteInt, integer, int8, `:,:,:',         inout)
VARD(put, 4D, EightByteInt, integer, int8, `:,:,:,:',       inout)
VARD(put, 5D, EightByteInt, integer, int8, `:,:,:,:,:',     inout)
VARD(put, 6D, EightByteInt, integer, int8, `:,:,:,:,:,:',   inout)
VARD(put, 7D, EightByteInt, integer, int8, `:,:,:,:,:,:,:', inout)
...
VARD(put, 1D, TwoByteInt, integer, int2,  :,              inout, _all)
VARD(put, 2D, TwoByteInt, integer, int2, `:,:',           inout, _all)
VARD(put, 3D, TwoByteInt, integer, int2, `:,:,:',         inout, _all)
VARD(put, 4D, TwoByteInt, integer, int2, `:,:,:,:',       inout, _all)
VARD(put, 5D, TwoByteInt, integer, int2, `:,:,:,:,:',     inout, _all)
VARD(put, 6D, TwoByteInt, integer, int2, `:,:,:,:,:,:',   inout, _all)
VARD(put, 7D, TwoByteInt, integer, int2, `:,:,:,:,:,:,:', inout, _all)

VARD(put, 1D, FourByteInt, integer, int,  :,              inout, _all)
VARD(put, 2D, FourByteInt, integer, int, `:,:',           inout, _all)
VARD(put, 3D, FourByteInt, integer, int, `:,:,:',         inout, _all)
VARD(put, 4D, FourByteInt, integer, int, `:,:,:,:',       inout, _all)
VARD(put, 5D, FourByteInt, integer, int, `:,:,:,:,:',     inout, _all)
VARD(put, 6D, FourByteInt, integer, int, `:,:,:,:,:,:',   inout, _all)
VARD(put, 7D, FourByteInt, integer, int, `:,:,:,:,:,:,:', inout, _all)

VARD(put, 1D, FourByteReal, real,   real,  :,              inout, _all)
VARD(put, 2D, FourByteReal, real,   real, `:,:',           inout, _all)
VARD(put, 3D, FourByteReal, real,   real, `:,:,:',         inout, _all)
VARD(put, 4D, FourByteReal, real,   real, `:,:,:,:',       inout, _all)
VARD(put, 5D, FourByteReal, real,   real, `:,:,:,:,:',     inout, _all)
VARD(put, 6D, FourByteReal, real,   real, `:,:,:,:,:,:',   inout, _all)
VARD(put, 7D, FourByteReal, real,   real, `:,:,:,:,:,:,:', inout, _all)

VARD(put, 1D, EightByteReal, real, double,  :,              inout, _all)
VARD(put, 2D, EightByteReal, real, double, `:,:',           inout, _all)
VARD(put, 3D, EightByteReal, real, double, `:,:,:',         inout, _all)
VARD(put, 4D, EightByteReal, real, double, `:,:,:,:',       inout, _all)
VARD(put, 5D, EightByteReal, real, double, `:,:,:,:,:',     inout, _all)
VARD(put, 6D, EightByteReal, real, double, `:,:,:,:,:,:',   inout, _all)
VARD(put, 7D, EightByteReal, real, double, `:,:,:,:,:,:,:', inout, _all)

VARD(put, 1D, EightByteInt, integer, int8,  :,              inout, _all)
VARD(put, 2D, EightByteInt, integer, int8, `:,:',           inout, _all)
VARD(put, 3D, EightByteInt, integer, int8, `:,:,:',         inout, _all)
VARD(put, 4D, EightByteInt, integer, int8, `:,:,:,:',       inout, _all)
VARD(put, 5D, EightByteInt, integer, int8, `:,:,:,:,:',     inout, _all)
VARD(put, 6D, EightByteInt, integer, int8, `:,:,:,:,:,:',   inout, _all)
VARD(put, 7D, EightByteInt, integer, int8, `:,:,:,:,:,:,:', inout, _all)
