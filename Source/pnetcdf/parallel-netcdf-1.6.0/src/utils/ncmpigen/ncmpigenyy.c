 ...
 *   $Id: ncmpigenyy.c 1667 2014-05-22 22:01:22Z wkliao $
 *********************************************************************/
 ...
 * we now use fwrite().
 */
#define ECHO (void) fwrite( ncmpitext, ncmpileng, 1, ncmpiout )
#endif
